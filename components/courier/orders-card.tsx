...
import { formatDateShortStriped, formatDateTime, formatTime24 } from "@/utils/formatter/datetime";
              ...
              <CardContent className="space-y-1">
                <div className="md:text-md flex justify-between text-sm">
                  ...
                  >
                    ...
                    <p className="bg-accent-foreground text-accent px-1 rounded-xs items-center justify-center text-center">{formatTime24(transaction.needed_time)}</p>
                  </span>
                </div>
                <div className="md:text-md flex justify-between text-sm">
